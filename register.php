...
<!--                    </div>-->
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                          <input type="password" name="pass" id="password" class="form-control input-lg" placeholder="Simple Pass" tabindex="5">
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                          <input type="password" name="repass" id="password_confirmation" class="form-control input-lg" placeholder="Confirm Pass" tabindex="6">
                        </div>
